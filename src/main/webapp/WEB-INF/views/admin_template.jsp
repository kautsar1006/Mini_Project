	...
	<div class="wrapper">
		...
		<header class="main-header bg-img">
			...
			<a href="/dashboard" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>MUF</b></span> <!-- logo for regular state and mobile devices -->
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								...
								class="hidden-xs">Kautsar Ramadhan S</span>
						</a>
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									...
									<p>
										Kautsar Ramadhan S - Developer <small>Member since
											Nov. 2012</small>
									</p></li>
								<!-- Menu Body -->
								<!-- <li class="user-body">
								...
								<li class="user-footer">
									<div class="pull-left">
										<button href="#" class="btn btn-default btn-flat">Profile</button>
									</div>
									<div class="pull-right">
										<button class="btn btn-default btn-flat" onclick="exit()">Sign
											out</button>
									</div>
								</li>
							</ul></li>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="${pageContext.request.contextPath }/member"><i
							class="fa fa-user-circle-o "></i> Member</a></li>
					<li><a href="${pageContext.request.contextPath }/asset"><i
							class="fa fa-briefcase "></i> Asset</a></li>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2014-2019 <a
				href="https://adminlte.io">Kautsar Ramadhan S</a>.
				...
				<div class="tab-pane" id="control-sidebar-settings-tab">
					<form method="post">
						...
						<div class="form-group">
							...
							<p>Allow the member to show his name in blog posts</p>
						</div>
						<!-- /.form-group -->
